...
anchor_generator在mmdetection/mmdet/models/dense\_heads/**anchor\_head.py**一共就出现过5次，逐一观察每一次做的事：
...
5. line 165, **valid_flags()**与pad_shape有关。
   ...
   mmdetection/mmdet/datasets/pipelines/transforms.py文件中调用了mmcv的impad函数（line 480）。
