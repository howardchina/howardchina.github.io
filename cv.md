...
<div class="cv">
	...
	<ol>
		...
		<li>
			Zou Beiji and Yulan Dai and <strong>Qi He</strong> and Chengzhang Zhu and Geng Liu and Yu Su and Ru Tang: Multi-Label Classification Scheme Based on Local Regression for Retinal Vessel Segmentation, <em>IEEE/ACM Transactions on Computational Biology and Bioinformatics</em>, DOI: 10.1109/TCBB.2020.2980233
		</li>
		<li>
	...
	<ul>
		...
		<li><strong>Central South University, Changsha, China</strong><br>
			...
			Graduation Project: A Cross-platform Retinal Image Database for Glaucoma diagnosis.<a href="https://github.com/howardchina/BGIDB">[code]</a></li>
	</ul>
	...
	<ol>
		...
		<li>
			...
			Wrote a Patent (in Chinese) as the first author: A pupil tracking algorithm in the dark room for corneal refractive surgery.<br>
			Advisors: <a href="mailto:mei.zhang@ia.ac.cn">Dr. Mei Zhang</a>
		</li>
		<li>
